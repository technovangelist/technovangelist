...
My name is **Matt** and I was a founding member of the maintainer team at [Ollama](https://ollama.com) (after we pivoted from making RBAC tools for K8s and SSH key management tools). Before that, I was the first Evangelist at a tiny startup called Datadog (well, it was only 30 people when I started there). 
...
------------
This page gets built for me automatically and was last built on Sunday, March 2, 10:29 PM PST.
